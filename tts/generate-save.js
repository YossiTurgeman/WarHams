...
//   faces 2, 4, 6 (the base-printed numbers that trigger Separatist
//   spawning per Phase 1) get RED pips; faces 1, 3, 5 stay BLACK.
//   Players can tell at a glance whether the grey die just spawned
//   trouble. Texture is generated by tts/generate-separatist-die.js
...
[
    ...
    if (d.custom) {
        // Custom_Dice — painted texture (red pips for spawn numbers).
        const die = baseObj("Custom_Dice", d.name,
            "Grey d6 — RED pips on 2, 4, 6 trigger Separatist spawning at the matching base. Black pips on 1, 3, 5 do not spawn.",
