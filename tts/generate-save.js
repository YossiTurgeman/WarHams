...
const PLANET_BOARD_URL = `${SOLDIER_BASE}/planet-board.png?v95`;
const planetBoard = baseObj("Custom_Tile", "Planet Board",
    ...
    0, 0.95, 2.5,
    { rotY: 0, scaleX: 45.0, scaleY: 0.2, scaleZ: 30.0,
...
const HEX_SCALE   = 4.5;   // v95: scaled 1.5× to fill enlarged planet board
const HEX_R_WORLD = 4.5;   // (must match generate-planet-board.js)
