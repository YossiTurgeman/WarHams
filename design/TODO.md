...
- [x] **Add dedicated combat zones.** — Added locked North and South Combat Boards around the dice tray. Each has numbered H.A.M.S positions 1–7 with matching die positions in front; the rules preserve every staged soldier's original board state and hex.
