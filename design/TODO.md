...
- [ ] **Set a casualty threshold for forcing Separatists out of a base.** Attackers must kill more than **X** base defenders before the surviving Separatists leave the base and become roaming forces. Determine the value of X and define what happens when the attackers do not reach it.
