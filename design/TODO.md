...
- [x] **Add 2 combat-location markers.** — Added two movable red circular markers matching the First Player marker's size. Combat declaration now places a marker at the board location and returns it after resolution.
