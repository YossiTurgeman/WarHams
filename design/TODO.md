...
- [x] **Add a large locked dice tray east of the Blue and Yellow player areas.** — Added a shared 30 × 12 enclosed throwing tray on the far-east edge, oriented with its long side facing south. It has a black floor, purple walls, and five permanently locked pieces; nearby resource bags and the Hex Randomizer sit north of it to keep the tray clear.
