...
- [x] **Add 2 combat-location markers.** — Added two movable red circular markers with white labels, matching the First Player marker's size. They stage above the First Player token; combat declaration places a marker at the board location and returns it after resolution.
