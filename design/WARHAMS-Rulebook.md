...
**W.A.R H.A.M.S (World Access Retrievable Heavy Assault Modifiable Suites) — The Battle for Planet X** is a sci-fi board game of corporate warfare, territorial control, and tactical betrayal for **2–4 players**, ages **14+**.

Each player commands a private military force — squads of heavily armed soldiers known as **H.A.M.S (Heavy Assault Modifiable Suites)** — deployed by a rival megacorporation to conquer a distant, resource-rich alien world. Victory belongs to the corporation that accumulates the most **Dominance Points (DP)** by seizing territory, harvesting resources, arming their squads with powerful **Basic Armament Cards (BACs)**, and manipulating the battlefield through cunning **Conspire Cards**.
...
| -------------------- | :----------: | :---: | ------------------------------------ |
| 🛢️ Oil Rig           | ⬛ Black     | 3     | Produces Oil (Oil Drum) resources          |
| ⚡ Power Plant        | 🟨 Yellow    | 3     | Produces Electricity (Lightning Bolt) resources    |
| 🏭 Factory           | 🟥 Red       | 3     | Produces Industry (Hammer) resources            |
| 📡 Radar Dish        | 🟦 Blue      | 3     | Produces Intelligence (Transmitting Wave) resources |
| 🏘️ City / Village    | 🟩 Green     | 3     | Produces Local Favor (Recruit) resources           |
| 🏴 Separatist Base   | ⬜ Grey      | 3     | Hostile NPC stronghold (printed numbers: 2, 4, 6) |
| 🚀 Spaceport Drop Zone | 🟪 Purple  | 6     | Reinforcement landing sites (printed numbers: 1–6) |
...
| Resource | Color | Depiction | Token | Token Colors |
| --- | :---: | --- | --- | --- |
...
| **Bunker Tokens**      | Neutral fortifications placed by D.U.D.S (Deployable Unital Defense System): +1 all defense dice on hex. 1 per hex max. Any unit benefits. Destroyed by attacker winning combat on the hex |
...
> ⚙️ *Always maintain 6 face-up cards in the Planet Bound Area. Whenever a card is taken, immediately replace it from the Spaceport Deck.*

Shuffle the **Advanced BAC Deck** (25 cards) separately and place it face-down next to the Conspire Deck. These cards are only available to players who have unlocked the corresponding prerequisite BAC type (see Equipping Rules).
...
Players deploy their starting Squads to the planet surface using a snake draft. H.A.M.S drop from orbit — landing zones must be clear of hostile forces and away from critical infrastructure to avoid casualties and collateral damage.
...
When BAC cards arrive at spaceports during the game (via doubles/triples):
...
> **Example:** You have an H.C.A.R (Heavy Caliber Assault Rifle) card in hand. You place it in the Equipment Display and put your red flag on it — H.C.A.R is now unlocked for you permanently. The first soldier is equipped for free. You pay 1 Industry + 1 Oil for each additional soldier and snap H.C.A.R rifle modules onto their Hands slot. Next turn, you recruit a new soldier and want to arm them too — just pay 1 Industry + 1 Oil again, no card needed.
...
- **Advanced BAC Deck Purchase:** If you have unlocked the corresponding prerequisite BAC type, you may spend **3 resource tokens of any single type** while your Squad is at or adjacent to a **Spaceport** or **City** → draw 1 face-down card from the **Advanced BAC Deck** into your hand. If you draw a card whose prerequisite you have not unlocked, keep it in your hand — you may equip it later once you unlock the prerequisite. Prerequisites: C.A.P Chest → S.A.P Chest, C.A.P Head → S.A.P Helmet, C.A.P Legs → S.A.P Legs, L.P.M → B.A.S.R or S.L.I.M.E, P.A.E.H → H.C.A.R.
...
After equipment bonuses are applied, both players may play **Combat Conspire Cards** (Guerrilla Warfare, Defender Instant Shield, Old School RPG, One Pulse Barrier) to alter the outcome.
...
- The **difference** between the final attack value and the final defense value equals the number of **damage pegs** inserted into the divots on that defending H.A.M.S's base.
- Each base has **3 blood-drop divots**. Insert one red peg per point of damage taken.
- **Damage persists between turns.** A wounded H.A.M.S keeps its pegs until healed by a card effect or ability (which removes pegs from the divots).
...
| Soldier B | 4 | 4 | +0 for defender | No counterattack (difference < 2) |
...
> Difference: 6 − 1 = **5** (≥ 2) — **Counterattack triggered!**
>
...
>
> The original attacker's defense die (5) beat the attack die (2) by **3** — above the threshold of 2.
...
At the **end of each round**, any player who suffered **3 or more wounds** (damage pegs placed on their soldiers, including kills) during that round gains **1 free resource token** of their choice for every full **3 wounds** suffered. The local population rallies behind a beleaguered commander, donating supplies to the war effort.

> *Example: 7 wounds suffered = 2 resource tokens. 2 wounds = 0 resource tokens.*
...
> *Bombarding cities wins battles but loses hearts and minds.*
...
| Property | Value |
|---|---|
| **Crew** | Requires **2 soldiers** |
| **Dice** | Roll **4d6** |
| **Target** | An **entire enemy Squad** up to **3 hexes** away |
| **Restriction** | Mortar crew **skips normal combat** |
| **Vulnerability** | **−1 defense** when attacked directly |
| **Civilian Damage** | Targeting a City/Village hex triggers the **Civilian Damage Rule**: all opposing players gain 2 Local Favor; attacker loses all Local Favor (see §Civilian Damage Rule) |
...
| Property | Value |
|---|---|
| **Function** | Extends B.A.S.R and S.L.I.M.E effective range |
| **Mechanic** | Weapons may target enemies **adjacent to the L.P.M carrier** |
| **Maximum Range** | **4 hexes** total |
| **Restriction** | L.P.M carrier does not fire — they designate targets |

---

### 🏗️ Bunker Rules

Bunker tokens are placed by the **D.U.D.S** (Deployable Unital Defense System) equipment module. Once deployed, a bunker becomes a permanent terrain feature on the hex.

| Rule | Detail |
|------|--------|
| **Placement** | Activate D.U.D.S to place a bunker token on the hex the soldier occupies. D.U.D.S module is removed from the soldier (one-use), freeing the backpack slot |
| **Effect** | **+1 to all defense dice** for any unit defending on this hex |
| **Ownership** | Bunkers are **neutral fortifications** — any unit on the hex benefits, regardless of faction |
...
BACs are the weapons, armor, gadgets, and tactical systems that transform your H.A.M.S from expendable grunts into an unstoppable force.

### Card Anatomy

| Zone | Location | Description |
|------|----------|-------------|
| **Name** | Top center | The BAC's full military acronym designation |
| **Cost** | Top right | Resource cost per soldier equipped |
| **Slot** | Bottom left | Equipment slot: Head, Backpack, Legs, Chest, or Hands |
| **DP Value** | Bottom right | Dominance Points this card contributes while equipped |
| **Card Text** | Center | The BAC's mechanical effect |

### Equipment Slots

Each soldier has **5 equipment slots**, determined by die roll when a slot is targeted:
...
Each soldier may carry **1 module per slot**. A Squad may equip multiple BAC types, but no individual soldier may double up on a single slot.

### Module Identification & the Equipment Display

Every equipment module has a **unique sculpt** — an H.C.A.R rifle looks different from a B.A.S.R sniper, a S.A.P Helmet looks different from a S.H.A.D (Sensory Helmet, Advisory Drone) helmet. Each module also has its **abbreviation engraved on the underside** for confirmation.

When a BAC type is equipped for the **first time** in the game, place its BAC card face-up in the **Equipment Display** — a shared area near the board visible to all players. Place one **reference module** on top of the card so everyone can see what that module looks like.

The Equipment Display serves as the communal reference for all active equipment in the game:

| What you need to know | Where to look |
|---|---|
| What does this module do? | Equipment Display — read the BAC card |
| What is this module's DP value? | Equipment Display — check the card |
| Which soldiers have this module? | Look at the minis — the sculpt matches the reference module |
| Who owns which modules? | The modules physically attached to each player's colored minis |

The **modules on the minis are the source of truth** — not cards, not boards. If a module is on your soldier, you have it. If it's not, you don't.

> **Tip:** Any player can pick up a module from the board and compare its sculpt to the reference modules in the Equipment Display to identify it.

### Equipping Rules

- Choose a BAC card from your **hand**. If this BAC type is not yet in the **Equipment Display**, place the card face-up there and place one of your **Control Flags** on it to mark it as permanently unlocked — **the first soldier is equipped for free** as part of unlocking. If it's already in the Equipment Display, discard the card and place your flag on the existing card.
...
- **Advanced BACs (Level 2):** Five BAC types are Level 2 — only available from the **Advanced BAC Deck** (a separate face-down deck next to the Conspire Deck), never in the Spaceport Deck or starting hands. Spend **3 resource tokens of any single type** at a Spaceport or City to draw 1 card from the Advanced BAC Deck. If you draw a card whose prerequisite you have not unlocked, keep it in your hand — you may equip it once you unlock the prerequisite. Prerequisites: C.A.P Chest → S.A.P Chest, C.A.P Head → S.A.P Helmet, C.A.P Legs → S.A.P Legs, L.P.M → B.A.S.R or S.L.I.M.E, P.A.E.H → H.C.A.R. To equip a C.A.P, trade in the corresponding S.A.P piece (detach it from the mini and return it to the supply) as part of the upgrade cost, then attach the C.A.P module.
...
Modules with active abilities fall into two timing categories:
...
|----------|------|-----------|------|------|----|--------|
| **🛡️ Armor** | S.A.P Chest | Standard Armor Plating Chest Piece | Chest | 1 Oil, 1 Industry | 1 | This soldier gets +1 to its defense die |
...
| **🛡️ Armor ⬆️** | C.A.P Chest | Custom Armor Plating Chest | Chest | 1 S.A.P Chest + 1 LF, 1 Ind, 1 Oil | 4 | This soldier gets +2 to its defense die |
| ⬆️ | C.A.P Head | Custom Armor Plating Helmet | Head | 1 S.A.P Head + 1 LF, 1 Int, 1 Oil | 4 | This soldier gets +2 to its defense die |
| ⬆️ | C.A.P Legs | Custom Armor Plating Legs | Legs | 1 S.A.P Legs + 1 LF, 1 Elec, 1 Oil | 4 | This soldier gets +2 to its defense die |
...
**⚔️ Combat Cards** (Guerrilla Warfare, Defender Instant Shield, Old School RPG, One Pulse Barrier):
- Played **only during combat** at Step 4 of combat resolution.
- **Defender** plays first, then **Attacker** responds.
- Each player may play any number of eligible Combat Conspire Cards.

**🎯 Tactical Cards** (all other Conspire Cards — resource exchange, free resource, territory control, etc.):
...
| Name | Cost | Effect | Copies |
|------|------|--------|:------:|
| Recruit Eager Volunteers | Free | Gain 1 Local Favor. Roll d6: on 5–6, gain 1 additional resource token of any type you choose | 3 |
| Scout Ahead | Free | Gain 1 Intelligence. Roll d6: on 5–6, gain 1 additional resource token of any type you choose | 3 |
| Tap into Oil Reserves | Free | Gain 1 Oil. Roll d6: on 5–6, gain 1 additional resource token of any type you choose | 3 |
| Proper Planning | Free | Gain 1 Industry. Roll d6: on 5–6, gain 1 additional resource token of any type you choose | 3 |
| Tap into the Local Power Grid | Free | Gain 1 Electricity. Roll d6: on 5–6, gain 1 additional resource token of any type you choose | 3 |
...
Militia are temporary local fighters summoned by the **Deal with Local Militia** Conspire Card. They are not a permanent force — they attack once and disperse.
...
> **Note:** Militia act on the summoning player's behalf — the summoning player assigns their attack dice and chooses matchups.
...
| Resource | Color | Depiction | Hex Tile | Token |
|----------|:-----:|----------|----------|:----------:|
...
| 8 | **Battle Victory DP** (player vs player only): side that inflicted more wounds earns DP = difference, up to 3 |
