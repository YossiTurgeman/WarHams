...
<!-- Generated from WARHAMS-Rulebook.md — do not edit directly. -->
...
- **S.L.I.M.E** (mortar) has extended range and may fire from beyond 1 hex (up to 3 hexes). Mortar crew count as engaged even if outside normal range. **B.A.S.R** (sniper) fires at up to 2 hexes in a **pre-combat step** — within normal engagement range, but its range can be extended via **L.P.M** (Laser Pointer Module) (up to 4 hexes). See **Special Weapon Rules** below.
...
> If the original attacker's defense triggers another counterattack, the chain continues with no penalty. Chains end naturally when a roll fails to trigger another counter.
...
Modules left on the hex may be picked up by the active player's soldier occupying that hex during **Phase 3: Salvage & Resource Gathering, Step 1**. Salvaged modules can be equipped for **free** (the cost was already paid) — simply attach the module to the soldier's mini. Check the **Equipment Display** to confirm the module's identity and effect.
...
| **Target** | **1 specific soldier** up to **2 hexes** away |
...
| **Effect** | All defenders suffer **−1 to all defense dice** |
...
| Rule | Detail |
|------|--------|
| **Placement** | Activate D.U.D.S to place a bunker token on the hex the soldier occupies. D.U.D.S is then flipped (one-use) |
...
Every equipment module has a **unique sculpt** — an H.C.A.R rifle looks different from a B.A.S.R sniper, a S.A.P Helmet looks different from a S.H.A.D drone helmet. Each module also has its **abbreviation engraved on the underside** for confirmation.
...
|----------|-----------------|----------|
| **Combat Modules** | During **combat resolution** at Step 3 (equipment bonuses) | N.I.N.J.A (+3 defense die) |
| **Field Modules** | During a **Logistics action** on your turn | P.L.A.S.T.E.R (heal damage), D.U.D.S (place bunker) |
...
> **Note:** The 5 Level 2 types (⬆️) are only available from the **Advanced BAC Deck**, not the Spaceport Deck. Prerequisites: C.A.P Chest → S.A.P Chest, C.A.P Head → S.A.P Helmet, C.A.P Legs → S.A.P Legs, L.P.M → B.A.S.R or S.L.I.M.E, P.A.E.H → H.C.A.R.
...
| H.C.A.R | Heavy Caliber Assault Rifle | Hands | 1 Industry, 1 Electricity | 2 | **Range 1.** +1 attack die |
...
| B.E.A.R | Battlefield Extraction Airlift Rover | Chest | 1 each of all 5 resources | 3 | Its occupied resource hex provides +1 token during Phase 3; does not stack |
...
| R.S.G | Repeating Shotgun | Hands | 1 Electricity, 1 Local Favor | 2 | **Range 1.** Same hex as target: +2 attack. Not same hex: -1 attack |
| P.C.S.M.G | Projectile Correcting Sub Machine Gun | Hands | 1 Electricity, 1 Industry, 1 Intelligence | 3 | **Range 1.** Same hex: roll 2d6 for attack instead of 1d6, pick the higher result |
